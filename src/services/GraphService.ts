interface ApplicationCsvDetail {
    id: string;
    displayName: string;
    appId: string;
...
interface GraphAppDetail {
    appId: string;
    description: string;
    homepageUrl: string;
    tags: string[];
    // Additional simulated Graph properties can be added here
}

class GraphService {
    private appDetailsMap: Map<string, ApplicationCsvDetail>;
    private simulatedGraphDetails: Map<string, GraphAppDetail>;

    constructor() {
        this.appDetailsMap = new Map();
        this.simulatedGraphDetails = new Map();
        this.initializeData();
    }
...
0afd5e86-eff5-4769-9dbf-b75866d280e7,AzureDataShare,799f1985-1