...
export enum IdentityVoiceCommand {
    ListAll = 'IDENTITY_LIST_ALL',
    FindByName = 'IDENTITY_FIND_BY_NAME',
    FindById = 'IDENTITY_FIND_BY_ID',
    FilterByType = 'IDENTITY_FILTER_BY_TYPE',
    ShowDetails = 'IDENTITY_SHOW_DETAILS',
}

export interface VoiceCommandRequest {
    command: IdentityVoiceCommand;
    parameters?: Record<string, string | boolean | number>;
}

// Raw CSV data embedded as per project requirements
const RAW_IDENTITY_CSV = `00a67483-ea0d-4bfa-a19b-17ae35e97fe3,ADP,3f18b202-a866-4c1f-b9c0-6598390a2092,2022-05-04T08:14:29Z,Enterprise Application,True,Visible,True,False
...
fefefbb4-5f46-4dda-837b-1dc751bf9ea2,Salesforce,35