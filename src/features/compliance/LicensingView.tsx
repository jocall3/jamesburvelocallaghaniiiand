...
import { format, parseISO, isFuture, addMonths, addDays } from 'date-fns';
...
const LicensingView: React.FC = () => {
    ...
    const handleDeleteRiskAssessment = async (assessmentId: string) => {
        setIsLoading(true);
        setAllRiskAssessments(prev => prev.filter(ra => ra.id !== assessmentId));
    ...
    return (
        <>
                                        ...
                                        <tr key={ra.id} className="border-b border-gray-700 hover:bg-gray-800/50">
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center space-x-2">
                                                    ...
                                                    <button onClick={() => handleDeleteRiskAssessment(ra.id)} className="text-red-500 hover:text-red-400 text-sm">Delete</button>
                                                </div>
                                            </td>
                                        </tr>
                                    ))
            ...
            <RiskAssessmentDetailsModal
                ...
                onDelete={handleDeleteRiskAssessment}
