...
const NonCompliantAppsWidget: React.FC = () => {
  const [nonCompliantApps, setNonCompliantApps] = useState<Application[]>([]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const rawData = `00a67483-ea0d-4bfa-a19b-17ae35e97fe3,ADP,3f18b202-a866-4c1f-b9c0-6598390a2092,2022-05-04T08:14:29Z,Enterprise Application,True,Visible,True,False
...
1cae7670-eef7-4b9d-bef8-6771c6842d6b,Azure API Management,8602e328-9b72-4f2d-a4ae-1387