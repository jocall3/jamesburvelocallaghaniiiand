            ...
            <div className="flex items-center justify-center space-x-6">
                ...
                <div className="text-left">
                    ...
                    <p className={change >= 0 ? 'text-green-400 text-sm mt-2' : 'text-red-400 text-sm mt-2'}>
                        {change >= 0 ? 'ÃƒÂ¢Ã¢â‚¬â€œÃ‚Â²' : 'ÃƒÂ¢Ã¢â‚¬â€œÃ‚Â¼'} {Math.abs(change)} points (30 Days)
                    </p>
                </div>
            </div>
        </Card>
    ...
    <Card title="Architect's Mandate: The Future of Value" className="border-red-500/50">
        <div className="text-sm text-gray-300 max-h-[400px] overflow-y-auto pr-4 space-y-5 custom-scrollbar">
            ...
            <div className="pb-2">
                ...
                <p className="leading-relaxed">
                    The Dashboard you interact with is merely the tip of the icebergÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬ the user-facing interface. Beneath this lies the distributed ledger, the AI risk assessment matrix, and the automated execution layer. Your engagement, your data, and your trust are the fuel for this expansion. Do not mistake convenience for compliance. You are not a customer; you are a node in a superior network.
                </p>
            </div>
        </div>
    </Card>
                        ...
                        <div className="flex justify-between items-baseline mb-4 border-b border-gray-700 pb-3">
                            <div>
                                ...
                                <p className={`text-lg font-semibold ${modal?.data?.change > 0 ? 'text-green-400' : 'text-red-400'}`}>
                                    {modal?.data?.change > 0 ? 'ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â²' : 'ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¼'} {Math.abs(modal?.data?.change).toFixed(2)} ({((modal?.data?.change / modal?.data?.price) * 100).toFixed(2)}%)
                                </p>
                            </div>
