...
export interface UCCProps extends VariantProps<typeof uccVariants> {
    ...
    cognitiveModelingAgentId?: QFOS_ID<'agent'>;
...
export class UCC {
    ...
    public draw(screen: ScreenBuffer) {
        ...
        const borderChar = variant === 'high-frequency' ? 'Îž' : 'â”€';
...
declare namespace React {
    function useState<T>(initial: T): [T, (newState: T) => void];
    function useEffect(effect: () => (() => void) | void, deps?: any[]): void;
    function useMemo<T>(factory: () => T, deps?: any[]): T;
    function useCallback<T extends (...args: any[]) => any>(callback: T, deps: any[]): T;
    function forwardRef<T, P = {}>(render: (props: P, ref: React.Ref<T>) => React.ReactElement | null): any;
    function memo<P extends object>(Component: React.FC<P>, areEqual?: (prevProps: Readonly<P>, nextProps: Readonly<P>) => boolean): any;
    type ReactNode = any;
